...
//  Socialcademy
//
//  Created by Brandon Kamplain on 8/17/23.
//
...
struct ImagePickerButton<Label: View>: View {
    ...
    @State private var showImageSourceDiaglogue = false
    @State private var sourceType: UIImagePickerController.SourceType?
    
    var body: some View {
        Button(action: {
            showImageSourceDiaglogue = true
        }) {
            label()
        }
        .confirmationDialog("Choose Image", isPresented: $showImageSourceDiaglogue) {
