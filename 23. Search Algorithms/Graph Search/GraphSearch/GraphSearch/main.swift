...
let dfs = graph.dfs(startingAt: node1)
...
let graph2 = Graph(nodes: [atlanta, newYork, chicago, orlando, losAngeles])
graph2.addEdges(from: atlanta, to: [(node: newYork, isBidirectional: false, weight: 250), (node: orlando, isBidirectional: false, weight: 80)])
graph2.addEdges(from: orlando, to: [(node: atlanta, isBidirectional: false, weight: 100), (node: newYork, isBidirectional: false, weight: 400), (node: chicago, isBidirectional: false, weight: 200)])
graph2.addEdges(from: losAngeles, to: [(node: chicago, isBidirectional: false, weight: 125), (node: atlanta, isBidirectional: false, weight:250)])
graph2.addEdge(from: chicago, to: newYork, isBidirectional: false, weight: 190)
graph2.addEdges(from: newYork, to: [(node: losAngeles, isBidirectional: false, weight: 400), (node: atlanta, isBidirectional: false, weight: 200)])
graph2.printGraph()

let dfs2 = graph2.dfs(startingAt: atlanta)
let bfs2 = graph2.bfs(startingAt: atlanta)
print("\nDepth First Search:\n\(dfs2)\n\nBreadth First Search:\n\(bfs2)")
